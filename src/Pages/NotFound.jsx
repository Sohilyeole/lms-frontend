...
return(
    <div className="w-full flex flex-col justify-center items-center h-screen bg-[1a2238]">
      <h1 className="text-9xl font-extrabold text-white tracking-widest">4o4</h1>
      <div className="bg-black text-white text-sm rounded rotate-12 absolute">
          Page Not Found
      </div>
      <button className="mt-5 ">
        <a className="relative inline-block text-sm font-medium text-[#FF6A3D] group active:text-yellow-500 focus:outline-none">
