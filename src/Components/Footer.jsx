import { BsFacebook, BsInstagram, BsLinkedin, BsTwitter } from "react-icons/bs"; //bs bootstrap
function Footer() {
  ...
  return (
    <>
      <footer className="relative left-0 bottom-0 h-[10vh] py-1 flex flex-col sm:py-5 sm:flex-row items-center justify-between text-white bg-gray-800  sm:px-20 ">
